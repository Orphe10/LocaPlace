                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                    <div class="card " style="border-radius: 15px;">
                        <div class="card-body p-5 my-5">
                            <h2 class="text-uppercase text-center text-primary mb-5">créer votre compte
                                <span>
                                    <h6><small>de propriétaires d'objet</small></h6>
                                </span>
                            </h2>
                            ...
                            @endif
                            <form method="POST" action="{{route('HandleAgenceRegister')}}"
                                enctype="multipart/form-data">
                                @method('post')
                                @csrf
                                <div data-mdb-input-init class="form-outline mb-4">
                                    <label class="form-label" for="form3Example1cg">Nom de l'agence</label>
                                ...
                                <div data-mdb-input-init class="form-outline mb-4">
                                    <label class="form-label" for="form3Example5cg">L'image de l'agence ou du propriétaire d'objet</label>
                                    <input type="file" id="form3Example5cg" name="image" accept="image/*"
                                        class="form-control form-control-lg" />
                                    @error('image')
                                    <div class="text-danger">{{$message}}</div>
                                    @enderror
                                ...
                                <div data-mdb-input-init class="form-outline mb-4">
                                    <label class="form-label" for="form3Example4cdg">Confirmer votre mot de
                                        passe</label>
                                ...
                                <p class="text-center text-muted mt-5 mb-0">Avez vous déjà un compte?
                                    <u class="fw-bold text-body" onclick="openpopup0()">Se connecter ici</u>
                                </p>
                            </form>
                        </div>
                    </div>
