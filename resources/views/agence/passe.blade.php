            ...
            <div class="d-flex flex-column align-content-end">
                <div class="app-auth-body mx-auto">
                    ...
                    <div class="auth-form-container text-left">
                        ...
                        <form action="{{ route('SendMotdepasseLoginAgence') }}" method="POST"
                        ...
                        <div class="auth-option text-center pt-5"><a class="app-link" href="{{ route('AgenceLogin') }}">Se connecter</a>
                            <span class="px-2">|</span> <a class="app-link" href="{{ route('AgenceRegister') }}">S'inscrire</a>
                        </div>
                    </div>
                    <!--//auth-form-container-->
                </div>
