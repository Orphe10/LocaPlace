<div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding ">
            <a href="{{route('DashboardAdmin')}}" class="navbar-brand d-flex  text-center">
                <div class="container d-flex align-items-center">
                    <img style="width:20%; margin-left: -10%;" src="{{ asset('assets/images/LOGO-SITE.png') }}">
                    <h1 class="my-auto text-primary ms-1">LocaPlace</h1>
                </div>
            </a>
        </div>
        <!--//app-branding-->
            ...
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{route('admin.agences.index')}}">
                        ...
                        <span class="nav-link-text">Liste des propriétaires</span>
                    </a>
                    <!--//nav-link-->
                </li>
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link" href="{{route('admin.locataire.liste')}}">
                        <span class="nav-icon">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-folder" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <span class="nav-link-text">Liste des locataires</span>
                    </a>
                    <!--//nav-link-->
                </li>
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link"
                                href="{{route('admin.article.attente')}}">Article en attente</a>
                            </li>
                            <li class="submenu-item"><a class="submenu-link"
                                href="{{route('admin.article.approuve')}}">Article aprouvée</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link" href="{{ route('admin.paiement') }}">
                        <span class="nav-icon">
