    ...
    <div class="container-fluid py-2">
        <div class="app-header-content">
            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="app-utilities col-auto ms-auto">
                    <div class="app-utility-item app-notifications-dropdown dropdown">
                        ...
                        <div class="dropdown-menu p-0" aria-labelledby="notifications-dropdown-toggle">
                            ...
                            <div class="dropdown-menu-content">
                                @forelse (Auth::user()->unreadNotifications as $notification)
                                    <div class="item p-3">
                                        ...
                                        <a class="link-mask" href="{{ route('admin.notifications.markAsRead', $notification->id) }}"></a>
                                    </div>
                                @empty
                                    <div class="item p-3">
                                        <div class="row gx-2 justify-content-between align-items-center">
                            ...
                            <div class="dropdown-menu-footer p-2 text-center">
                                <a href="{{ route('admin.notifications.index') }}">Voir tout</a>
                            </div>
                        </div>
                    </div>
                    <div class="app-utility-item app-user-dropdown dropdown ">
                        <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#"
                            role="button" aria-expanded="false"><img src="https://ui-avatars.com/api/?name={{ auth('admin')->user()->email }}
                            " alt="user profile" style="border-radius:50%"></a>
                        <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                            <li><a class="dropdown-item" href="{{route('AdminLogout')}}">Se déconnecter</a></li>
                        </ul>
                    </div>
                </div>
                <!--//app-utilities-->
